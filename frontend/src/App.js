     ...
     <Header/>
        <form >
          <div class="box">
            ...
            <label for="nota2" ><img src="assets/2.png" alt="nota 2"/></label>

            <input id="nota3" type="radio" name="nota_atendimento" value="3"/>
            <label for="nota3" ><img src="assets/3.png" alt="nota 3"/></label>

            <input id="nota4" type="radio" name="nota_atendimento" value="4"/>
            <label for="nota4" ><img src="assets/4.png" alt="nota 4"/></label>

            <input id="nota5" type="radio" name="nota_atendimento" value="5"/>      
            <label for="nota5" ><img src="assets/5.png" alt="nota 5"/></label>
          </div>
